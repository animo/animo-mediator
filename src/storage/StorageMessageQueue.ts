...
export class StorageServiceMessageQueue implements MessageQueue {
  ...
  public constructor(agentConfig: AgentConfig, messageRepository: MessageRepository, agentContext: AgentContext) {
    this.logger = agentConfig.logger
    this.messageRepository = messageRepository
    this.agentContext = agentContext
  }

  public async takeFromQueue(connectionId: string, limit?: number, keepMessages = false) {
